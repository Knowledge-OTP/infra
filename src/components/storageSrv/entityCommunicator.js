(function (angular) {
    ...
    angular.module('znk.infra.storage').factory('EntityCommunicatorSrv', [
        '$cacheFactory', '$q',
        function ($cacheFactory, $q) {
            ...
            function EntityCommunicatorSrv(path, defaultValue, getter, setter) {
                this.path = path;
            ...
            EntityCommunicatorSrv.prototype.get = function () {
                var path = this.path;
                ...
                getProm = getProm.then(function(_entity){
                    ...
                    //for (var prop in defaultValue) {
                        //if (angular.isUndefined(_entity[prop])) {
                        //    _entity[prop] = angular.copy(defaultValue[prop]);
                        //}
                    //}
                    return _entity;
                });
            ...
            EntityCommunicatorSrv.prototype.set = function (entity) {
                var key = this.path;
