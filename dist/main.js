...
(function (angular) {
    ...
    angular.module('znk.infra.znkLesson').factory('SubjectEnum', [
        'EnumSrv',
        function (EnumSrv) {
...
(function (angular) {
    ...
    angular.module('znk.infra.znkLesson').controller('activeLessonCtrl',
        ["$mdDialog", "SubjectEnum", "LessonSrv", function($mdDialog, SubjectEnum, LessonSrv) {
            'ngInject';
...
(function (angular) {
    ...
    angular.module('znk.infra.znkLesson').provider('LessonSrv',
        function() {
            ...
            this.$get = ["$log", "ENV", "AuthService", "InfraConfigSrv", "StudentContextSrv", "UtilitySrv", "SubjectEnumConst", "$mdDialog", function($log, ENV, AuthService, InfraConfigSrv,  StudentContextSrv, UtilitySrv,
...
angular.module('znk.infra.znkLesson').run(['$templateCache', function($templateCache) {
  $templateCache.put("components/znkLesson/components/lessonBtn/znkLesson.template.html",
    "<md-button class=\"lesson-btn\"\n" +
    "           ng-click=\"vm.showLessonModal()\">\n" +
    "    <span ng-if=\"!vm.isLessonActive\">{{'ZNK_LESSON.START_LESSON' | translate}}</span>\n" +
    "    <span ng-if=\"vm.isLessonActive\">{{'ZNK_LESSON.END_LESSON' | translate}}</span>\n" +
    "</md-button>\n" +
    "");
  $templateCache.put("components/znkLesson/modals/templates/activeLesson.template.html",
    "<div class=\"start-lesson-modal\">\n" +
    "    <md-dialog class=\"base\" translate-namespace=\"ZNK_LESSON\">\n" +
    "        <div class=\"close-popup-wrap\" ng-click=\"vm.closeModal()\">\n" +
    "            <svg-icon name=\"znkLesson-close-popup\"></svg-icon>\n" +
    "        </div>\n" +
    "        <md-dialog-content>\n" +
    "            <div class=\"main-title\" translate=\".HAVE_ACTIVE_LESSON\"></div>\n" +
    "        </md-dialog-content>\n" +
    "    </md-dialog>\n" +
    "</div>\n" +
    "");
  $templateCache.put("components/znkLesson/modals/templates/startLesson.template.html",
    "<div class=\"start-lesson-modal\">\n" +
    "    <md-dialog class=\"base\" translate-namespace=\"ZNK_LESSON\">\n" +
    "        <div class=\"close-popup-wrap\" ng-click=\"vm.closeModal()\">\n" +
    "            <svg-icon name=\"znkLesson-close-popup\"></svg-icon>\n" +
    "        </div>\n" +
    "        <md-dialog-content>\n" +
    "            <div class=\"main-title\" translate=\".LESSON_SUBJECT\"></div>\n" +
    "            <div class=\"lessons-types\">\n" +
    "                <div class=\"lesson-icon-wrap\"\n" +
    "                     ng-repeat=\"subject in vm.lessonsSubjects\"\n" +
    "                     ng-class=\"subject.name\"\n" +
    "                     ng-click=\"vm.startLesson(subject); vm.closeModal();\">\n" +
    ...
    "</div>\n" +
    "");
  $templateCache.put("components/znkLesson/svg/znkLesson-close-popup.svg",
    "<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" x=\"0px\" y=\"0px\"\n" +
    ...
    "</svg>\n" +
    "");
  $templateCache.put("components/znkLesson/svg/znkLesson-english-icon.svg",
    ...
    "</svg>\n" +
    "");
  $templateCache.put("components/znkLesson/svg/znkLesson-math-icon.svg",
    "<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\"\n" +
    "     xml:space=\"preserve\"\n" +
    "     x=\"0px\" y=\"0px\"\n" +
    "     class=\"math-icon-svg\"\n" +
    ...
    "</svg>\n" +
    "");
  $templateCache.put("components/znkLesson/svg/znkLesson-verbal-icon.svg",
    "<svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\"\n" +
